...
*   **Automation:** Can a computer *run* the analysis, with *any* valid inputs, with minimal (even none at) human intervention?
...
*   **Examples:**
    ...
    *   Using a smaller subset of actual input data, so tests can be run quickly and make it easier to determine when something has broken.
...
*   **Best practice: Aim for both!** The ideal scenario is to have an automated analysis that is also fully reproducible. This ensures that the analysis is both efficient and trustworthy. You can automate your documentation and version control as well!
